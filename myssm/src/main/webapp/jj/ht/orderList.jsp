...
<nav class="breadcrumb">
    ...
    <div class="page-container">
       ...
       <%--<div class="cl pd-5 bg-1 bk-gray mt-20">--%>
					<%--<span class="l"> <a href="javascript:;"--%>
                                        <%--onclick="admin_add('订单添加','jj/ht/order_add.jsp','600','500')"--%>
    ...
    <%--</div>--%>
                ...
                <tr class="text-c">
                    ...
                    <td class="td-manage">
                        <%--<a title="编辑" href="javascript:;"--%>
                           <%--onclick="admin_edit('订单编辑','/order.do?findByCidOrder&cid=${c.CId}','1','600','500')"--%>
                           <%--class="ml-5" style="text-decoration: none"><i--%>
                                <%--class="Hui-iconfont">&#xe6df;</i>--%>
                        <%--</a>--%>
                        <a title="删除" href="${pageContext.request.contextPath}/order.do?deleteOrder&cid=${c.CId}"
        ...
        <p align="center">
            ...
            总页数：${total}
            <a href="${pageContext.request.contextPath}/order.do?listOrder&index=${index-1}"><c:if
