...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>js css3响应式时间轴动画特效</title>

    <link href="./js css3响应式时间轴动画特效_files/demo.css" rel="stylesheet" media="all">
    ...
    <script src="./js css3响应式时间轴动画特效_files/hm.js.下载"></script><script type="text/javascript" src="./js css3响应式时间轴动画特效_files/jquery.min.js.下载"></script>
    <script type="text/javascript" src="./js css3响应式时间轴动画特效_files/jquery.qrcode.min.js.下载"></script>
...
<div id="iframe-wrap">
    <iframe id="iframe" src="./js css3响应式时间轴动画特效_files/demo.html" frameborder="0" width="100%" height="572px"></iframe>
</div>
